...
| **v2.0.33-elemont** | **Vinu BLS12-381 fork**                                                 | Adds the `VinuBLS12381` rule bit, RLP serialization, staged activation after Prague, and BLS12-381 precompile activation at `0x0b`-`0x11`. Mainnet stayed false for this flag until a separate activation release.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
